	...
	<div class="product_image_area">
		<div class="container">
			<div class="row s_product_inner">
				<?php
				$query = "SELECT * FROM tbl_girls_wallets WHERE product_id =$_GET[product_id]";
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<h2><a class="active">RS. <?php echo $row['product_price'] ?></a></h2>
						<ul class="list">
							<li><a class="active"><span>Category</span> : <?php echo $row['category'] ?></a></li>
