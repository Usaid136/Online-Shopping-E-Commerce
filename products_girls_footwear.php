...
if (isset($_GET['product_id'])) {
    $query = "DELETE FROM `tbl_girls_footwear` WHERE product_id=$_GET[product_id]";
    $result = mysqli_query($conn, $query);
}
// Table gift end
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <h1 class="text-center">Girls Footwear Products</h1><br><br><br>
                    </div>
                </div>
                <?php
                            ...
                            <div class='col'>
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href=<?php echo "update_girls_footwear.php?product_id=$row[product_id]" ?>
                                            class="btn btn-success">Update Product</a>
                                        <br><br>
                                        <a href=<?php echo "products_girls_footwear.php?product_id=$row[product_id]" ?> class="btn btn-danger">Delete
                                            Product</a>
                                    </div>
                                </div>
                            </div>
