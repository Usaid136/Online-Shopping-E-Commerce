					...
					<div class="login_form_inner">
						...
						<form class="row login_form"  method="POST" id="contactForm" novalidate="novalidate">
							<div class="col-md-12 form-group">
								<input type="email" class="form-control" id="name" name="email" placeholder="Enter your email" required>
							</div>
							<div class="col-md-12 form-group">
						...
						<?php
                                    if(isset($_POST["btnlogin"])){
                                        $email=$_POST["email"];
                                        $pass=$_POST["password"];
                                        $query="select * from  customer_login where email='$email' and password='$pass'";
