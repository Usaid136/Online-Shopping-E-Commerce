...
if (!empty($_SESSION['cart'])) {
    ...
    <form action='place_order.php' method='POST'>
        ...
        <input type='number' name='contact_no' required><br>
    ...
    <section class="checkout_area section_gap">
        <div class="container">
            <div class="billing_details">
                <div class="row">
                <div class='col-lg-8'>
                <h3 class='text-center'>Shipping & Billing Details</h3>
                <h5 style='color: red;'>Kindly fill the form to checkout!</h5>
...
if (!empty($_SESSION['cart'])) {
    echo "                    
                        <form class='row contact_form' action='place_order.php' method='POST'>
                            ...
                            <label for='full_name'>Full Name</label><br>
                                <input type='text' class='form-control' id='first' name='full_name' placeholder='Enter Your Full Name' required>
                            </div>
                            <div class='col-md-6 form-group p_star'>
                            <label for='contact_no'>Contact No</label><br>
                                <input type='number' class='form-control' id='number' name='contact_no' placeholder='Enter Your Contact No' required>
                            </div>
                            <div class='col-md-6 form-group p_star'>
                            <label for='email'>Email</label><br>
                            ...
                            <textarea name='shipping_address' class='form-control' placeholder='Enter Correct Shipping Address' required></textarea>
                            </div>
                            <div class='col-md-12 form-group'>
                            <label for='payment_method'>Payment Method</label><br>
                                <select class='payment_method' required>
                                    <option value='COD'>Cash On Delivery</option>
                                </select>
                            </div>
                            <button type='submit' class='primary-btn'>Proceed to CheckOut</button> &nbsp; &nbsp;
                            <a href='cart.php' class='primary-btn'>Edit Cart</a>
                        </form>";
                     }
?>
                    </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        if (!empty($_SESSION['cart'])) {
                            foreach ($_SESSION['cart'] as $item) {
                                ...
                                echo "
                                <ul class='list'>
                                <li><a style='color: black;'>Products<span class='middle'>Quantity</span> <span class='last'>Total</span></a></li>
                               </ul>
                            <ul class='list'>
                                <li><a>{$item['product_name']}<span class='middle' style=' text-align: center;'>{$item['product_quantity']}</span> <span class='last'>RS {$item['product_price']}</span></a></li>
                               </ul>
                               <hr>
                            <ul class='list list_2'>
                                <li><a>Subtotal <span>RS ". number_format($sub_total, 2) ."</span></a></li>
                                <li><a>Shipping Fee <span>RS ". number_format($ship, 2) ."</span></a></li>
                                <li><a>Total<span>RS ". number_format($total, 2) ."</span></a></li>
                            </ul>
                        ";
                            }
                        } else {
	...
	<!-- php end -->
            ...
            <div class="footer-bottom d-flex justify-content-center align-items-center flex-wrap">
                <p class="footer-text m-0">					Copyright &copy; All rights reserved | This website is developed and designed by <a href="">M.Usaid Saddiq</a>. For inquiries or custom website services, Contact at <a href="tel:+923300262678">+923300262678</a> Or Email at <a href="mailto:muhammadusaid136@gmail.com">muhammadusaid136@gmail.com</a>.
</p>
            </div>
        </div>
    </footer>
