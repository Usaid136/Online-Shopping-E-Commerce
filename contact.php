	...
	<section class="contact_area section_gap_bottom">
		<div class="container">
			...
			<div id="map_area">
				<div class="box">
					<iframe
						src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3620.3071878583323!2d67.25827396059444!3d24.853355827841963!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb3310d55359ce9%3A0x8fa5d4436aa55b92!2sSector%2017-A%20Shah%20Latif%20Town%2C%20Karachi%2C%20Karachi%20City%2C%20Sindh%2C%20Pakistan!5e0!3m2!1sen!2s!4v1728913524290!5m2!1sen!2s"
			...
			<div class="row">
				<div class="col-lg-3">
					<div class="contact_info">
						<div class="info_item">
							...
							<h6>Sector 17A Shah Latif Town District Malir Karachi</h6>
							<p>Visit Us</p>
						</div>
						<div class="info_item">
							<i class="lnr lnr-phone-handset"></i>
							<h6><a href="tel:+923300262678">+923300262678</a></h6>
							<p>Monday to Sunday 24/7</p>
						</div>
						<div class="info_item">
							<i class="lnr lnr-envelope"></i>
							<h6><a href="mailto:muhammadusaid136@gmail.com">muhammadusaid136@gmail.com</a></h6>
				...
				<div class="col-lg-9">
					<form class="row contact_form" method="post" id="contactForm" novalidate="novalidate">
						...
						<div class="col-md-6">
							<textarea class="form-control mt-2" name="message" id="message" cols="30" rows="5"
								placeholder="Enter Message" required></textarea>
						</div>
						<div class="col-md-12 text-right">
							<input type="submit" class="btn primary-btn mt-2" value="Send Message" name="btninsert">
						</div>
					</form>
				</div>
			</div>
