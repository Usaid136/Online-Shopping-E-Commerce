...
<body>
	...
	<section class="contact_area section_gap_bottom">
		...
		<br>
			<div class="row">
				<div class="col text-center"><h1 style="color: rgba(255, 135, 0, 0.74);">Your Feedback Is Important For Us</h1>
				<br>
			</div>
			</div>
			<div class="row">
			<div class="col">
					<form class="row contact_form"  method="post" id="contactForm" novalidate="novalidate">
						<div class="col-md-8">
								...
								<input type="text" class="form-control mt-2" id="name" name="name" placeholder="Enter Your Name" required>
								<label for="email">Email</label>
								<input type="email" class="form-control mt-2" id="email" name="email" placeholder="Enter Email Address" required>
						</div>
						<div class="col-md-8">
						<label for="msg">Message</label>
								<textarea class="form-control mt-2" name="message" id="message" cols="30" rows="5" placeholder="Enter Your Message" required></textarea>
						</div>
						<div class="col-md-8 text-right">
						<input type="submit" class="btn primary-btn mt-2" value="Send Message"
						name="btninsert">
						</div>
					</form>
				</div>
