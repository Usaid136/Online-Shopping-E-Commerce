			...
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						...
						<a href="View_wallets.php"><?php echo $row['product_name'] ?></< /a>
					</nav>
				</div>
			</div>
		</div>
	...
	<div class="product_image_area">
		<div class="container">
			<div class="row s_product_inner">
				...
				$result = $conn->query("SELECT * FROM tbl_boys_bags WHERE product_id =$_GET[product_id]");
				...
				<div class='col-lg-5 offset-lg-1'>
					...
					<h2><a class='active'>RS. $row[product_price]</a></h2>
						<ul class='list'>
							<li><a class='active'><span>Category</span> : Boys Bags </a></li>
