...
<body id="category">
			...
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						...
						<a href="product_boys_belt.php">Boys Belts</a>
					</nav>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
				...
				<section class="lattest-product-area pb-40 category-list">
					...
					<div class="row">
						...
						// Fetch products from Boys Belts
        ...
        <form action='add_to_cart.php' method='POST'>
            ...
            <a href='View_boys_belts.php?product_id=$row[product_id]' class='btn btn-more'>View More</a>
        </form>
		</div>
					</div>
					</div>
