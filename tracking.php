                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="tracking.php">Track order</a></li>
    ...
    <section class="tracking_box_area section_gap">
        <div class="container">
            <div class="tracking_box_inner">
                <p>To track your order please enter your 09 digit Order number in the box below and press the "Track" button.
                    Order number
                    was given to you on your Order Details Page.</p>
                <form class="row tracking_form" action="check_status.php" method="post">
                    <div class="col-md-12 form-group">
                        <input type="number" class="form-control" id="order_id" name="order_id"
                            placeholder="Order number" required>
                        <br>
                        <input type="submit" value="Track Order" class="primary-btn">
                    </div>
                </form>
            </div>
        </div>
