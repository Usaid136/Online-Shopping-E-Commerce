...
<body id="category">
	...
	<div class="container">
        ...
        <form action='add_to_cart.php method='POST'>
            ...
            <a href='View_arts.php?product_id=$row[product_id]' class='btn btn-more'>View More</a>
        </form>
		</div>
					</div>
					</div>
