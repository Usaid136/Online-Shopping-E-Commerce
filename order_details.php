...
<body>
	...
	<section class='order_details section_gap'>
		<div class='container'>
			<h3 class='title_confirmation'>Thank you. Your order has been confirmed.</h3>
			<?php
$order_id = $_GET['order_id'];
$result = $conn->query("SELECT o.*, c.full_name, c.contact_no, c.email, c.shipping_address
                        FROM orders_info o
...
echo"
			<div class='row order_d_inner'>
				<div class='col-lg-4'>
					<div class='details_item'>
						<h4>Order Info</h4>
						<ul class='list'>
							<li><a><span>Order number</span> :  {$row['order_id']}</a></li>
							<li><a><span>Date & Time</span> :  {$row['order_date']}</a></li>
							<li><a><span>Total</span> : {$row['total_amount']} Rs</a></li>
							<li><a><span>Contact No</span> : {$row['contact_no']}</a></li>
						</ul>
					</div>
				</div>
				<div class='col-lg-4'>
					<div class='details_item'>
						<h4>Order Info</h4>
						<ul class='list'>
							<li><a><span>Total Products</span> :  {$row['total_products']}</a></li>
							<li><a><span>Order Status</span> :  {$row['order_status']}</a></li>
							<li><a><span>Payment method</span> : {$row['payment_method']}</a></li>
							<li><a><span>Name</span> : {$row['full_name']}</a></li>
						</ul>
					</div>
				</div>
				<div class='col-lg-4'>
					<div class='details_item'>
						...
						<ul class='list'>
							<li><a><span>Shipping Address</span> : {$row['shipping_address']}</a></li>
							<li><a><span>City</span> : Karachi</a></li>
							<li><a><span>Country</span> : Pakistan</a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<a href="index.php" class='primary-btn' style="border: none;">continue shopping</a>
	</section>
